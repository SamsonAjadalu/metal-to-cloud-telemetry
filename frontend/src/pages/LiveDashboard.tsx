...
const Dashboard: React.FC = () => {
    ...
    const handleModeSwitch = () => {
        telemetryService.sendCommand('MODE_SWITCH', { mode: 'MANUAL' });
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem', marginTop: '2rem' }}>
                        ...
                        <div className="card" style={{ padding: '1.5rem', border: '1px solid #ddd', borderRadius: '8px', boxShadow: '0 4px 6px rgba(0,0,0,0.1)' }}>
                            ...
                            <div style={{ display: 'flex', gap: '1rem', marginTop: '1rem' }}>
                                ...
                                <button onClick={handleModeSwitch} style={{ background: '#0d6efd', color: 'white', padding: '0.75rem 1.5rem', border: 'none', borderRadius: '4px', cursor: 'pointer', fontWeight: 'bold', fontSize: '1.1rem', flex: 1 }}>Switch Mode</button>
                            </div>
                        </div>
                    </div>
