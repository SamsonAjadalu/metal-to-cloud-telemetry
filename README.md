...
Our project consists of **6,307** lines of authored code in this scope, covering core application logic, robotics integration, and cloud orchestration. Third-party libraries, build artifacts, and non-essential static assets are excluded for a fair picture of team contribution. Primary development was in **Python** and **TypeScript**.
...
Store files under **`docs/images/`** so paths work from the repository root (e.g. in **`README.md`** on GitHub). Each subsection below lists the filename, caption, and Markdown you can paste.
